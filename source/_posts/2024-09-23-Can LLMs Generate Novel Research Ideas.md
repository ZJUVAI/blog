...
<center style="color:#000000;font-family:Arial">表9 将每个review视为一个数据点来评分所有条件（测试1），size是每个条件的审查数量，p值是使用双尾Welch's t-test和Bonferroni校正计算的</center>
...
<center style="color:#000000;font-family:Arial">表13 人类审稿人之间的审稿分数一致性（第一组），人类与AI之间的一致性（第二组）</center>

<img src=".\Table11.png" alt="Table11" style="zoom:55%;" />
...
![fig4_AI生成相似idea的统计图](D:\研究生阶段\实验室\组会\20240923\figs\fig4_AI生成相似idea的统计图.png)

<center style="color:#000000;font-family:Arial">图3 测量人工智能生成Idea的重复性：左侧图表显示了每个新生成Idea桶中非重复Idea的百分比；右侧图表显示了随着Agent不断生成新Idea，累积的非重复Idea。所有数据点都是跨所有主题平均的。</center>
